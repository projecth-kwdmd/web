    ...
    <main>
          ...
          <section className="market-section">
            <div className="container">
              ...
              <div className="summary-banner">
                Project H.는 함께 살아가는 새로운 삶의 방식을 실험하며,<br />
      ...
      <section className="value-cards value-fixed">
        <div className="value-card">
          ...
          <p>한곳에 머물지 않고 이동하며 살아가는 현대인의 삶을 존중합니다. Project H는 원하는 지역에서 머물고 떠날 수 있는<br />
            유연한 거주 방식을 제안합니다.</p>
        </div>

        <div className="value-card">
          <h4 data-label="B.">정서적 고향</h4>
          <p>자주 이동해도 마음이 쉴 곳은 필요합니다.<br />
            Project H는 지역과 사람을 연결해 언제든 <br />
            돌아올 수 있는 정서적 기반을 만듭니다.</p>
        </div>

        <div className="value-card">
          <h4 data-label="C.">지속 가능한 공동체</h4>
          <p>개인과 지역이 함께 성장하는 순환형 구조를<br />
            지향합니다. Project H는 공간의 재활용과 협력을 통해 <br />
            오래 지속될 수 있는 공동체를 구축합니다.</p>
        </div>
      </section>
      ...
      <section className="blue-logo">
        ...
        <img src="/projecth..png" className="blue-text" alt="Project H 텍스트" />
      </section>
      ...
      <section className="logo-description">
        <p>
          자유로운 삶을 꿈꾸는 당신에게,<br />
          Project H.는 <span className="em">‘당신만의 프로젝트’</span>를 위한 공간이자,<br />
          <span className="em">‘진정한 마음의 고향’</span>을 찾아가는 여정입니다.
        </p>
      </section>
